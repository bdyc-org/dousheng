...
type Comment struct {
	...
	CreatDate string `thrift:"creat_date,4" json:"creat_date"`
}
...
func (p *Comment) GetCreatDate() (v string) {
	return p.CreatDate
}
...
func (p *Comment) SetCreatDate(val string) {
	p.CreatDate = val
}
...
func (p *Comment) writeField4(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("creat_date", thrift.STRING, 4); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteString(p.CreatDate); err != nil {
		return err
	}
	if err = oprot.WriteFieldEnd(); err != nil {
		goto WriteFieldEndError
...
func (p *Comment) DeepEqual(ano *Comment) bool {
	...
	if !p.Field4DeepEqual(ano.CreatDate) {
		return false
	}
	return true
}
...
func (p *Comment) Field4DeepEqual(src string) bool {
	...
	if strings.Compare(p.CreatDate, src) != 0 {
		return false
	}
	return true
}

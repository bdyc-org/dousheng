...
func (p *NewFollowRequest_) FastReadField2(buf []byte) (int, error) {
	offset := 0
...
func (p *NewFollowRequest_) fastWriteField2(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
...
func (p *NewFollowRequest_) field2Length() int {
	l := 0
